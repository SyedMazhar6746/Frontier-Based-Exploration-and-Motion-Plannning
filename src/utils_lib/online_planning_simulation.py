...
def compute_dynamic_window(current_pose, current_speed, current_yaw_rate, path,  state_validity_checker):
    ...
    max_speed = 1  # Maximum linear speed #1.5
    max_yaw_rate = 1  # Maximum angular speed  # 1.5
    max_accel = 0.4  # Maximum linear acceleration #0.5
    max_delta_yaw_rate = 0.3  # Maximum angular acceleration 0.8
    #min_speed = -1
